              ...
              <div>
                <div className="flex items-center flex-wrap gap-2">
                  ...
                  <span className="px-2 py-0.5 text-[10px] font-mono font-bold bg-primary/10 text-primary border border-primary/20 rounded-md">
                    {bulkStatus.modelName || "gemini-1.5-flash"}
                  </span>
                  {bulkStatus.limit && (
                ...
                <p className="text-xs text-muted-foreground mt-0.5">
                  {bulkStatus.isPaused
                    ...
                    : bulkStatus.isRunning 
                    ? `Actief bezig met analyseren en classificeren volgens de Steenwijkerlandse datataxonomie (gemini-1.5-flash, max 10 RPM)...` 
