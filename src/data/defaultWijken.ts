...
export const BUURTKAART_WIJKEN: DefaultWijkData[] = [
  ...
  },
  {
    ...
    heroBannerUrl: "/assets/oostermeenthe-banner.jpg",
  ...
  // =========================================================================
  {
    ...
    is_grouped: true,
    bannerUrl: "https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=1920&auto=format&fit=crop&q=80",
    heroBannerUrl: "https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=1920&auto=format&fit=crop&q=80",
  ...
  },
  {
    ...
    gemeente: "Steenwijkerland",
    is_grouped: true,
    bannerUrl: "https://images.unsplash.com/photo-1512470876302-972faa2aa9a4?w=1920&auto=format&fit=crop&q=80",
    heroBannerUrl: "https://images.unsplash.com/photo-1512470876302-972faa2aa9a4?w=1920&auto=format&fit=crop&q=80",
  ...
  },
  {
    ...
    gemeente: "Steenwijkerland",
    is_grouped: true,
    bannerUrl: "https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=1920&auto=format&fit=crop&q=80",
    heroBannerUrl: "https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=1920&auto=format&fit=crop&q=80",
  ...
  },
  {
    ...
    gemeente: "Steenwijkerland",
    is_grouped: true,
    bannerUrl: "https://images.unsplash.com/photo-1584003564911-a7a321c84e1c?w=1920&auto=format&fit=crop&q=80",
    heroBannerUrl: "https://images.unsplash.com/photo-1584003564911-a7a321c84e1c?w=1920&auto=format&fit=crop&q=80",
  ...
  },
  {
    ...
    gemeente: "Steenwijkerland",
    is_grouped: true,
    bannerUrl: "https://images.unsplash.com/photo-1448375240586-882707db888b?w=1920&auto=format&fit=crop&q=80",
    heroBannerUrl: "https://images.unsplash.com/photo-1448375240586-882707db888b?w=1920&auto=format&fit=crop&q=80",
  ...
  },
  {
    ...
    gemeente: "Steenwijkerland",
    is_grouped: true,
    bannerUrl: "https://images.unsplash.com/photo-1511497584788-87676104235f?w=1920&auto=format&fit=crop&q=80",
    heroBannerUrl: "https://images.unsplash.com/photo-1511497584788-87676104235f?w=1920&auto=format&fit=crop&q=80",
  ...
  },
  {
    ...
    gemeente: "Steenwijkerland",
    is_grouped: true,
    bannerUrl: "https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?w=1920&auto=format&fit=crop&q=80",
    heroBannerUrl: "https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?w=1920&auto=format&fit=crop&q=80",
  ...
  },
  {
    ...
    gemeente: "Steenwijkerland",
    is_grouped: true,
    bannerUrl: "https://images.unsplash.com/photo-1513836279014-a89f7a76ae86?w=1920&auto=format&fit=crop&q=80",
    heroBannerUrl: "https://images.unsplash.com/photo-1513836279014-a89f7a76ae86?w=1920&auto=format&fit=crop&q=80",
  ...
  },
  {
    ...
    gemeente: "Steenwijkerland",
    is_grouped: true,
    bannerUrl: "https://images.unsplash.com/photo-1544551763-46a013bb70d5?w=1920&auto=format&fit=crop&q=80",
    heroBannerUrl: "https://images.unsplash.com/photo-1544551763-46a013bb70d5?w=1920&auto=format&fit=crop&q=80",
  ...
  return BUURTKAART_WIJKEN.map((defWijk) => {
    ...
    if (existing) {
      ...
      return {
        ...
        naam: resolvedNaam,
        type: defWijk.type,
        gemeente: defWijk.gemeente || existing.gemeente,
        bannerUrl: (existing.bannerUrl && existing.bannerUrl !== "/assets/hero-banner.jpg") ? existing.bannerUrl : defWijk.bannerUrl,
        heroBannerUrl: defWijk.heroBannerUrl || existing.heroBannerUrl || defWijk.bannerUrl,
